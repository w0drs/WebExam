...
- Сделать репозиторий на GitHub, создать папки css/js, файлы index.html, dashboard.html, настроить Git
...
![Главная страница сайта языковой школы](static/img/AddingCources.gif)
